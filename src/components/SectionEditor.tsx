        ...
        <div className="flex flex-col lg:flex-row lg:gap-6">
          ...
          <div className="lg:w-1/2">
            {displayImage ? (
              ...
              <label className="flex flex-col items-center justify-center w-full h-48 lg:h-64 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-colors">
                <svg
          ...
          <div className="mt-4 lg:mt-0 lg:w-1/2">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm resize-none lg:h-48"
